    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "MyGradient" },
                React.createElement("stop", { offset: "0%", stopColor: "#fdf361" }),
                React.createElement("stop", { offset: "100%", stopColor: "#ce629f" }))),
...
var Ul = styled.ul(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  list-style: none;\n  color: white;\n  @media (max-width: 967px) {\n    display: none;\n  }\n\n  li {\n    display: inline-block;\n  }\n\n  li:not(:first-child) {\n    margin-left: 20px;\n  }\n\n  li div a {\n    padding: 5px 0;\n    font-size: 14px;\n  }\n\n  li div a:hover {\n    color: ", ";\n  }\n\n  svg {\n    fill: url(#MyGradient);\n    vertical-align: middle;\n    margin-top: -5px;\n    margin-right: 4px;\n  }\n\n  .socialIcons svg {\n    margin-right: -15px;\n  }\n"], ["\n  list-style: none;\n  color: white;\n  @media (max-width: 967px) {\n    display: none;\n  }\n\n  li {\n    display: inline-block;\n  }\n\n  li:not(:first-child) {\n    margin-left: 20px;\n  }\n\n  li div a {\n    padding: 5px 0;\n    font-size: 14px;\n  }\n\n  li div a:hover {\n    color: ", ";\n  }\n\n  svg {\n    fill: url(#MyGradient);\n    vertical-align: middle;\n    margin-top: -5px;\n    margin-right: 4px;\n  }\n\n  .socialIcons svg {\n    margin-right: -15px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.secondary;
});
var DropdownLink = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  cursor: pointer;\n"], ["\n  cursor: pointer;\n"])));
var Wrapper = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav = styled.nav(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
            ...
            React.createElement(Ul, null,
                React.createElement("li", null,
                    React.createElement("a", { href: "/" },
                        ...
                        "Home")),
                React.createElement("li", null,
                    React.createElement(Dropdown, { target: React.createElement(DropdownLink, null,
                            React.createElement(Icon$9, { width: "24px", mr: "8px" }),
                            "Trade") },
                        React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://www.traderjoexyz.com/#/trade?outputCurrency=0x0Aa4ef05B43700BF4b6E6Dc83eA4e9C2CF6Af0fA" }, "Exchange"),
                        React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://www.traderjoexyz.com/#/pool/avax/0x0Aa4ef05B43700BF4b6E6Dc83eA4e9C2CF6Af0fA" }, "Liquidity"))),
                React.createElement("li", null,
                    React.createElement("a", { href: "/farms" },
                        React.createElement(Icon$p, { width: "24px", mr: "8px" }),
                        "Farms")),
                React.createElement("li", null,
                    React.createElement("a", { href: "/pools" },
                ...
                React.createElement("li", null,
                    React.createElement(Dropdown, { target: React.createElement(DropdownLink, null,
                            ...
                            "More") },
                        React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://github.com/polyswift/" }, "Github"),
                        React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://docs.swiftfinance.farm/" }, "Docs"))),
                React.createElement("li", { className: "socialIcons" },
                    React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://twitter.com/Swift_Finance/" },
                        React.createElement(Icon$8, { width: "24px", mr: "0" }))),
                React.createElement("li", { className: "socialIcons" },
                    React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://telegram.com/swiftfinanceavax/" },
                        React.createElement(Icon$b, { width: "24px", mr: "0" })))),
